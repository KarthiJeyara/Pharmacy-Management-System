                ...
                <div class="p-3 p-lg-5 border">
                  <div class="border mb-3">
                    ...
                    <div class="collapse" id="collapsebank">
                      ...
                      <div class="form-group">
                          <button class="btn btn-primary btn-md btn-block" onclick="window.location='thankyou.html'">Place Order
                          </button>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="border mb-3">
                    ...
                    <div class="collapse" id="collapsecheque">
                      ...
                      <div class="form-group">
                        <button class="btn btn-primary btn-lg btn-block" onclick="window.location='prescription_bank_deposit.php'">Place Order</button>
                      </div>
                    </div>
                  </div>
