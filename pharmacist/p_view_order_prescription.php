...
<head>
    ...
    <title>Pharmacist | View Orders - Prescription</title>
    <!-- Google Fonts -->
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <h3>Customer's Order Details - Prescription</h3>    
            </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <div class="card" style="padding:10px">
                    ...
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item"><b>Delivery Address :</b> <?php echo htmlspecialchars($order_details['o_address']); ?></li>
                        <li class="list-group-item"><b>Grand Total: </b><?php echo htmlspecialchars($order_details['o_total_amount']); ?></li>
                    </ul>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-group list-group-flush">
                            <?php if ( ($order_details['p_image']) != ''){ ?>
                                            <img style="width: 400px;height:auto" id="img01" src="../customer/uploads/<?php echo  ($order_details['p_image']); ?>" alt=""/>
                                        ...
                                        <?php } else {  echo "no image";    ?>
                                            <img style="width: 100px;height:auto" id="img01" src="../customer/uploads/<?php echo  ($order_details['p_image']); ?>" alt=""/>
