...
<head>
    ...
    <title>Pharmacist | Edit Order status</title>
    <!-- Google Fonts -->
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <ol class="breadcrumb breadcrumb-bg-teal align-right" style="background-color:#333 !important;">
                <li ><a href="javascript:void(0);">Pharmacist | Customer's Order Management</a></li>
            </ol>
    ...
    <div class="modal-content">
                    ...
                    ?>     
                        <div class="body">
                            ...
                            <label >Total Amount</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text"  class="form-control" disabled  value="<?php echo $total_amount; ?>" >
                                    </div>
                                </div>
                            <label >Status</label>
                                <div class="form-group">
        ...
        <div class="modal-footer"> 
            <div class="form-group"> 
                ...
                <a href="order_list.php"><button type="button" class="btn btn-danger m-t-15 waves-effect">Cancel</button></a>
            </div> 
        </div>
