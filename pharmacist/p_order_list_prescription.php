...
<head>
    ...
    <title>Pharmacist | Order Management | Prescription</title>
    <!-- Google Fonts -->
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <ol class="breadcrumb breadcrumb-bg-teal align-right" style="background-color:#333 !important;">
                <li ><a href="javascript:void(0);">Order Management | Prescription</a></li>
            </ol>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                               All Details of Orders - Prescription
                            </h2>
                            <ul class="header-dropdown m-r--5">
                                <li>
                                    <button  type="button" class="btn btn-warning waves-effect" data-toggle="modal" data-target="#myModal"> <i class="fa fa-plus m-r-5" style="color:white"></i> <span>Price requested Prescriptions</span> </button>
                                </li>
                            </ul>
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="prescription-zoom">
                                                <img style="width:100%;" id="img<?= $prescription_row['id']; ?>" src="../customer/uploads/<?= htmlspecialchars($prescription_row['prescription']); ?>" alt=""/>
                                            </div>
                                        </td>
                                        <td>
                                            <input type="text" class="form-control" name="price[<?= $prescription_row['id']; ?>]" value="<?= $prescription_row['price']; ?>">
                                        </td>
                                        <td>
                                            <button type="submit" name="update_price" value="<?= $prescription_row['id']; ?>" class="btn btn-success">Update</button>
                                        </td>
                                    </tr>
                                    <?php
                                }
...
{
  window.location.href='p_order_list_prescription.php?delete_id='+id;
  }
}
...
$updateSuccess = false; // Variable to track update success
...
// Check if the update was successful and set the alert message
if ($updateSuccess) {
    echo '<script>alert("Price updated successfully."); window.location.href ="p_order_list_prescription.php";</script>';
