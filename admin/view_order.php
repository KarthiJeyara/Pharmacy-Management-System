...
if (isset($_GET['view_id'])) {
    $order_details = $admin->viewOrderGetOrderDetails($connection, $_GET['view_id']);
} else {
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="card" style="padding:10px">
                        <div class="card-body">
                            ...
                            <ul class="list-group list-group-flush">
                                <?php
                                $product_names = explode(', ', $order_details['product_names']);
                                $product_doses = explode(', ', $order_details['product_doses']);
                                $item_quantities = explode(', ', $order_details['item_quantities']);

                                // Loop through products
                                for ($i = 0; $i < count($product_names); $i++) {
                                    echo '<li class="list-group-item">';
                                    echo '<b>Product Name:</b> ' . htmlspecialchars($product_names[$i]) . '<br>';
                                    echo '<b>Dose:</b> ' . htmlspecialchars($product_doses[$i]) . '<br>';
                                    echo '<b>Quantity:</b> ' . htmlspecialchars($item_quantities[$i]);
                                    echo '</li>';
                                }
                                ?>
                            </ul>
